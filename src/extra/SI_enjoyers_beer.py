...
y = df[rating]
fig = tpl.figure()
fig.plot(x, y, width=60, height=20,xlabel="Volume (%)",plot_command="plot '-' with p pt -22")
fig.show()
input('')
print("________________________________________________________________________________________________________________________\n")
...
y = df[rating]
fig = tpl.figure()
fig.plot(x, y, width=100, height=100,xlabel="Untappd Rating",plot_command="plot '-' with p pt -22")
fig.show()
input('')
print("________________________________________________________________________________________________________________________\n")
...
y = df[rating]
fig = tpl.figure()
fig.plot(x, y, width=100, height=100, xlabel="Size (mL)",plot_command="plot '-' with p pt -22")
fig.show()
input('')
print("________________________________________________________________________________________________________________________\n")
...
y = df[rating].values
fig = tpl.figure()
fig.plot(x, y, width=100, height=100, xlabel="Price (kr/L)",plot_command="plot '-' with p pt -22")
fig.show()
input('')
print("________________________________________________________________________________________________________________________\n")
...
y = df[rating].values
fig = tpl.figure()
fig.plot(x, y, width=100, height=100, xlabel="Day")
fig.show()
input('')
print("________________________________________________________________________________________________________________________\n")
...
fig = tpl.figure()
fig.plot(df[rating],df['Weis'],title=f"{rating} vs Weis", xlabel=rating,plot_command="plot '-' with p pt -22")
fig.show()
print("\n\n")
input('')
fig = tpl.figure()
fig.plot(df[rating],df['Peter'],title=f"{rating} vs Peter", xlabel=rating,plot_command="plot '-' with p pt -22")
fig.show()
print("\n\n")
input('')
fig = tpl.figure()
fig.plot(df[rating],df['Carl'],title=f"{rating} vs Carl", xlabel=rating,plot_command="plot '-' with p pt -22")
fig.show()
print("\n\n")
input('')
fig = tpl.figure()
fig.plot(df[rating],df['Patrick'],title=f"{rating} vs Patrick", xlabel=rating,plot_command="plot '-' with p pt -22")
fig.show()
print("\n\n")
input('')
fig = tpl.figure()
fig.plot(df[rating],df['Rasmus'],title=f"{rating} vs Rasmus", xlabel=rating,plot_command="plot '-' with p pt -22")
fig.show()
print("\n\n")
input('')
...
time.sleep(1.0*tf)
print("By a mere 0.02 kr. (apparently guessing 30.02kr. on a price rather than 30kr. can win you the competition!)")
time.sleep(7.0*tf)
